...
export function handleErrorAlert(text) {
	switch (text) {
		...
		case 'invalid_username':
			...
			break;
		case 'invalid_user':
			Alert.alert('Girdiğiniz kullanıcı bilgileri yanlış!', 'Kullanıcı adınızı ve şifrenizi doğru girdiğinizden emin olun');
			break;
		case 'null_login_user':
			Alert.alert('Eksik bilgi!', 'Kullanıcı adı veya şifre boş bırakılamaz');
			break;
		case 'null_register_user':
			Alert.alert('Eksik bilgi!', 'Kendini boş olarak kaydetmek istemezsin!');
			break;
